...
export default function StatsForm(props: StatsFormProps): JSX.Element {
	...
	function toggleStatsBase(nuevoTieneStatsBase: boolean): void {
		setTieneStatsbase(nuevoTieneStatsBase);
		if (nuevoTieneStatsBase) {
	...
	function toggleHP(nuevoTieneHP: boolean): void {
		setTieneHP(nuevoTieneHP);
		if (nuevoTieneHP) {
